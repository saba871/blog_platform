...
const FeaturedBlogPost = ({
  ...
  return (
    <article
      onClick={onClick}
      className="group grid grid-cols-12 bg-white rounded-2xl overflow-hidden cursor-pointer border border-gray-100 hover:border-gray-200"
    >
      {/* Cover image */}
      ...
      <div className="col-span-7 flex flex-col justify-between p-8">
        ...
        <div className="flex-1">
          <h2 className="text-xl font-bold text-gray-900 mb-3 line-clamp-3 leading-snug">
            {title}
          </h2>
