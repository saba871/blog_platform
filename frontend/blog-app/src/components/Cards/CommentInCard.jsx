...
const CommentInCard = ({
    ...
    return (
        <div
            className={`bg-white border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 p-4 ${isSubReply ? 'mb-2' : 'mb-4'}`}
        >
            {/* Main Row */}
            <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            {!isSubReply && (
                                <>
                                    <button
                                        ...
                                        className="flex items-center gap-1.5 text-[12px] font-medium text-sky-700 bg-sky-50 px-3 py-1 rounded-full hover:bg-sky-500 hover:text-white transition-colors duration-150"
                                    >
                            ...
                            <button
                                onClick={() => onDelete()}
                                className="flex items-center gap-1.5 text-[12px] font-medium text-sky-700 bg-sky-50 px-3 py-1 rounded-full hover:bg-rose-500 hover:text-white transition-colors duration-150"
                            >
                ...
                {post && (
                    <div className="flex items-center gap-3 bg-gray-50 border border-gray-100 rounded-xl p-2 flex-shrink-0 max-w-[240px]">
                        ...
                        />
                        <p className="text-[12px] font-medium text-gray-700 line-clamp-2 leading-snug">
                            {post?.title}
                        </p>
                    </div>
                )}
